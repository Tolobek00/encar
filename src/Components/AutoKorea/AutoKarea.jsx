  ...
  return (
    <div className='bloc-container'>
      ...
      <div className='container-ak'>
        ...
        <h1>Честный пробег</h1>
        <p>Скрутить пробег в Корее нельзя, т.к. это <br /> уголовное преступление и никто не будет с <br /> этим связываться + пробег легко проверить <br /> через базы страховых компаний</p>
